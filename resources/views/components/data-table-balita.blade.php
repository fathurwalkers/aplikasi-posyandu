            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="text-center">{{ intval($item->data_umur) }} (Bulan)</td>
                        <td class="text-center">{{ $item->data_tipe }} </td>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center">
                                                <img src="{{ asset('default-img/foto') }}/{{ $item->data_foto }}" alt="" class="img img-thumbnail" width="50%">
                                            </div>
                                        </div>
                                        <hr />
                                            <div class="row">
                                                <div class="col-sm-4 col-md-4 col-lg-4">
                                                    <h5 class="fix-text">Nama Lengkap </h5>
                                                    <h5 class="fix-text">Nama Orang Tua / Wali </h5>
                                                    <h5 class="fix-text">Jenis Kelamin </h5>
                                                    <h5 class="fix-text">Umur </h5>
                                                    <h5 class="fix-text">Kelompok Usia </h5>
                                                    <h5 class="fix-text">Alamat </h5>
                                                </div>
                                                <div class="col-sm-8 col-md-8 col-lg-8">
                                                    <h5 class="fix-text">: {{ $item->data_nama_lengkap }} </h5>
                                                    <h5 class="fix-text">: {{ $item->data_nama_orang_tua }} </h5>
                                                    <h5 class="fix-text">:
                                                        @switch($item->data_jenis_kelamin)
                                                            @case("L")
                                                                Laki - Laki
                                                    ...
                                                    <h5 class="fix-text">: {{ $item->data_umur }} (Bulan) </h5>
                                                    <h5 class="fix-text">: {{ $item->data_tipe }} </h5>
                                                    <h5 class="fix-text">: {{ $item->data_alamat_lengkap }} </h5>
                                                </div>
                                            </div>
                                        <hr />
                                    </div>
