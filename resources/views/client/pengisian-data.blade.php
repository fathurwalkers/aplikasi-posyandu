...
@section('main-content')
    ...
    <section class="profile" id="profile">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5 class="mb-3">Pengisian Data</h5>
                </div>
                <div class="col-12">
                    @if (session('status'))
                ...
                <div class="col-12">
                    <form action="{{ route('post-pengisian-data') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="card border-1 py-1 bg-transparent">
                            <div class="card-body bg-transparent text-center">
                                <img src="{{ asset('tampilan/img') }}/user.png" class="card-img-top" alt="profile" id="output_image" />
