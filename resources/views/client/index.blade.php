...
@section('main-content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
      ...
      <section id="content" class="content py-5 d-flex justify-content-center align-items-center" style="min-height: 100%">
        <div class="container">
          <a href="{{ route('client-menu-makanan') }}" class="card kartu mb-3 text-decoration-none bg-warning text-white p-0">
            <div class="row g-0">
              <div class="col-8">
          ...
          <a href="{{ asset('tampilan') }}/profil-grafik.html" class="card mb-3 text-decoration-none grafik text-white p-0">
            <div class="row g-0">
              <div class="col-8">
                <div class="card-body px-1">
          ...
          <a href="{{ asset('tampilan') }}/status-gizi-anak.html" class="card mb-3 text-decoration-none status-gizi text-white p-0">
            <div class="row g-0">
              <div class="col-8">
                <div class="card-body px-1">
